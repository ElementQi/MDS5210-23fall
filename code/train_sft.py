...
def train(pretrain, batch_size, exp_name):
    ...
    # change those settings in configs.py or inside train_sft.fit()
    # batch_size = cfg.batch_size
    cfg.max_steps = 20000 // batch_size
    ...
    # ckpath = "/kaggle/working/src/runs/sft_tenprompts_202312220941/sft_tenprompts_202312220941_final.pt"

    # model = torch.compile(GPT.from_checkpoint(cfg, ckpath))
    # model = GPT.from_checkpoint(cfg, ckpath, True)
